...
cmd_template_usage() {
  echo_message "Usage: $(basename "$0") template <subcommand> [options/arguments]"
  echo_message "\nSubcommands:"
  ...
  echo_message "\nExamples:"
  echo_message "  $(basename "$0") template create myvm my_template"
  echo_message "  $(basename "$0") template list"
  echo_message "  $(basename "$0") template delete my_template"
}
